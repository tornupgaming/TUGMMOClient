...
namespace TUGLib.Web
{
    public class HtmlHelper
    {
        ...
        public static string GetStringResponseFromURL(string url, CookieContainer cookies, string postData) {
            HttpWebResponse resp = null;
            Stream respStream = null;
            string strResp = "";
            HttpWebRequest req = GenerateHttpRequest(url, cookies, postData);
